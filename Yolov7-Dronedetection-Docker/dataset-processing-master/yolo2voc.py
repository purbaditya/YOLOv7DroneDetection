...
# Corrected error with coordinate conversions
# Authors - D. Ahlers, P. Bhattacharya, P. Nowak
"""Converter
Convert YOLO <-> VOC
"""
import argparse
...
class config:
    LABEL_DIR = "datasets/dronedataset_color/Extra_Campus/Yolo_label_00003"
    IMAGE_DIR = "datasets/dronedataset_color/Extra_Campus/Campus_00003"
    XML_DIR   = "datasets/dronedataset_color/Extra_Campus/VOC_label_00003"
...
def yolo2voc(txt_file: str) -> None:
    ...
    # corrected coordinate conversion from yolo to voc (xml in Labelimg starts at 1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--yolo2voc", action="store_true", default = False, help="YOLO to VOC")
