...
class LoadStreams:  # multiple IP or RTSP cameras or gst stream
    def __init__(self, sources='streams.txt', img_size=640, stride=32, mem = 4):
        self.mode = 'stream'
        self.img_size = img_size
        self.stride = stride
        ...
        for i, s in enumerate(sources):
            ...
            thread = Thread(target=self.update, args=([i, cap, mem]), daemon=True)
