...
from flask import Flask, Response, render_template #added by edouard
...
import threading #added by edouard
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/color/exp/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='datasets/dronedataset_infrared/dreier-stativ-test/Sony/00006', help='source')  # file/folder, 0 for webcam
